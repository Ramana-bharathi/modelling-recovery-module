...
#initial conditions
r₀,v₀,u₀,traj=IC #traj-trajectory 
#of capsule till now-not needed for calculation
...
#plotting the solution
 display(plot(x,y,z,label="trajectory",
    xaxis="x (m)",yaxis="y (m)",
    zaxis="z (m)",grid=(:on,:black)))
savefig("./plots/trajectory-3.png")
...
savefig("./plots/energyplot-3.png")
